...
\noindent
\kakkoichi\quad 適当に点を打って状況を整理すると以下の通りである．
...
\begin{tikzpicture}[scale=1]
    ...
    \draw [purple, semithick, ->] (\lineangle:0.7) arc (\lineangle:0:0.7);
    \draw [->, orange] (A) -- ($(A)!0.48!(O)$);
    \draw [->, orange] (A) -- ($(A)!0.52!(O)$);
    \draw [orange] (A) -- (O);
    \draw [->, orange] (Z) -- ($(Z)!0.48!(Zp)$);
    \draw [->, orange] (Z) -- ($(Z)!0.52!(Zp)$);
    \draw [orange] (Z) -- (Zp);
    \draw [->, orange] (RZ) -- ($(RZ)!0.48!(RZp)$);
    \draw [->, orange] (RZ) -- ($(RZ)!0.52!(RZp)$);
    \draw [orange] (RZ) -- (RZp);
    ...
    \draw [purple, semithick, ->] (Zp) arc (\startangle:\endangle:\rZprime);
    ...
    \draw [purple, semithick, ->] (RZp) arc (\RZstartangle:\RZendangle:\rRZprime);
\end{tikzpicture}
\end{minipage}
\end{center}
